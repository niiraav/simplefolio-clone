          ...
          <div className="mb-10">
            ...
            {(project.role || project.timeline) && (
              <div className="flex flex-wrap gap-4 text-sm text-muted-foreground mb-4">
                {project.role && (
                  <span className="px-3 py-1 bg-secondary rounded-full">{project.role}</span>
                )}
                {project.timeline && (
                  <span className="px-3 py-1 bg-secondary rounded-full">{project.timeline}</span>
                )}
              </div>
            )}
            ...
            {project.liveUrl && (
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-background border border-border rounded-full font-medium text-foreground hover:bg-secondary transition-colors"
              >
                Live Website
            ...
            <>
              ...
              {project.sections?.map((section, index) => (
                <div key={index} className="mb-16">
                  ...
                  {/* Pull Quote */}
                  {section.pullQuote && (
                    <blockquote className="border-l-4 border-primary pl-6 py-4 my-8 bg-secondary/30 rounded-r-lg">
