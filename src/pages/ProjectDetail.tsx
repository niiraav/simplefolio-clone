  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="pt-8">
        ...
        <section className="max-w-[510px] mx-auto px-4 md:px-0">
          ...
          <div className="flex flex-col md:items-start md:justify-between gap-4 mb-10 md:flex md:flex-col">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground leading-tight max-w-[300px]">
              {project.title}
            </h1>
            {project.liveUrl && <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-background border border-border rounded-full font-medium text-foreground hover:bg-secondary transition-colors whitespace-nowrap">
                Live Website
          ...
          {project.images[2] && <div className="rounded-[24px] overflow-hidden bg-muted mb-16">
              <img src={project.images[2]} alt={`${project.title} - Detail 2`} className="w-full aspect-[4/3] object-cover" />
            </div>}
        </section>
