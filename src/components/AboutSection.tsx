const AboutSection = () => {
  return <section id="about" className="py-20 max-w-[510px] mx-auto px-4 bg-primary-foreground">
        <h2 className="text-2xl font-bold text-foreground mb-6 text-left font-serif">
          About
        </h2>
